...
const ShoppingCart = () => {
  ...
  const handleQuantityChange = async (productId, quantity) => {
    if (quantity >= 1 && quantity <= 20) {
      if (user) {
        await dispatch(updateCartThunk({ productId, quantity }));
      } else {
        dispatch(updateQuantityLocal({ productID: productId, quantity }));
      }
    }
  };
              ...
              <div className="orderCompleteSection">
                <div className="orderComplete">
                  ...
                  <div className="orderInfo">
                    ...
                    <div className="orderInfoItem">
                      <p>Total</p>
                      <h4>${(totalPrice === 0 ? 0 : totalPrice + 16).toFixed(2)}</h4>
                    </div>
                    <div className="orderInfoItem">
                      <p>Payment Method</p>
